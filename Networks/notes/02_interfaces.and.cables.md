...
Interfaces and cables are the physical components that connect network devices and allow data to travel across a network at Layer 1 of the OSI model. For CCNA 200-301, focus on the basics: common Ethernet interfaces, copper and fiber cable types, connector standards, cable categories and speeds, and how different cables are used to establish communication between network devices.
